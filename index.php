...
<head>
    ...
    <script>
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyBYjaUYET4b0-YGDXEOmyIH7g4MYvaoIAg",
            authDomain: "projetmaintenance-9e701.firebaseapp.com",
            databaseURL: "https://projetmaintenance-9e701.firebaseio.com",
            projectId: "projetmaintenance-9e701",
            storageBucket: "projetmaintenance-9e701.appspot.com",
            messagingSenderId: "654449409599",
            appId: "1:654449409599:web:b9d5d2bbb4966318b2c28a",
            measurementId: "G-9THVN0TCRK"
        };
        // Initialize Firebase
        ...
        var boissons = new Array();

        db.collection("boissons").get().then((querySnapshot) => {
            querySnapshot.forEach((doc) => {
                boissons.push([doc.id, doc.data()["marque"], doc.data()["quantite"], doc.data()["prix"]]);
            });
        });
